            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  value=""
                  name="price-sort"
                  onChange={()=>dispatch({type:"SORTBYS",payload:{sortBy:"lowtohigh"}})}
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  value=""
                  name="price-sort"
                  onChange={()=>dispatch({type:"SORTBYS",payload:{sortBy:"hightolow"}})}
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  value=""
                  name="rating-sort"
                  onChange={()=>dispatch({type:"RATINGS",payload:{ratings:"4STAR"}})}
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  value=""
                  name="rating-sort"
                  onChange={()=>dispatch({type:"RATINGS",payload:{ratings:"3STAR"}})}
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  value=""
                  name="rating-sort"
                  onChange={()=>dispatch({type:"RATINGS",payload:{ratings:"2STAR"}})}
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  value=""
                  name="rating-sort"
                  onChange={()=>dispatch({type:"RATINGS",payload:{ratings:"1STAR"}})}
